  ...
  return (
    <div className="w-full max-w-[600px] mx-auto mb-5 px-5">
      <form className="flex items-center relative w-full bg-white border-2 border-[#28a745] rounded-[50px] px-4 py-2 shadow-[0_4px_6px_rgba(40,167,69,0.1)]" onSubmit={(e) => e.preventDefault()}>
        <button type="button" className="bg-transparent border-none p-0 cursor-pointer flex items-center justify-center mx-2 mr-2 hover:[&>svg]:fill-[#218838]">
        ...
        />
        {searchTerm && (
          <button type="button" className="bg-transparent border-none p-0 cursor-pointer flex items-center justify-center mx-2 ml-2 hover:[&>svg]:fill-[#218838]" onClick={handleReset}>
            <svg viewBox="0 0 24 24" width="20" height="20" className="fill-[#28a745] transition-[fill] duration-200">
              <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" />
            </svg>
          </button>
        )}
        <label htmlFor="image-upload" className="bg-transparent border-none p-0 cursor-pointer flex items-center justify-center mx-2 ml-2 hover:[&>svg]:fill-[#218838]">
          <svg viewBox="0 0 24 24" width="20" height="20" className="fill-[#28a745] transition-[fill] duration-200">
